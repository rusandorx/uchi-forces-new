...
export const TaskCard = ({
  ...
  failed
	...
	return (
		<Card
			className="bg-zinc-100 dark:bg-[#1e1f21] hover:bg-zinc-350/2 hover:dark:bg-[#212128] hover:cursor-pointer"
			onClick={onClick}
		>
			{completed && (
				<ActionTooltip
					label={"Вы уже прошли эту задачу!"}
					capitalize={false}
				>
			...
			{created && (
				<ActionTooltip
					label={"Вы создатель этой задачи"}
					capitalize={false}
				>
      			...
      			{failed && (
				<ActionTooltip
					label={"Вы не решили эту задачу"}
					capitalize={false}
				>
					<div className="absolute w-5 bg-rose-500 h-5 rounded-tl-md rounded-br-sm" />
				</ActionTooltip>
			)}
			<CardHeader>
